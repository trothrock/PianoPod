...
public class PianoPod {
    ...
    public static func pianoView(backgroundColor: Color = .white,
                                 accentColor: Color = .gray,
                                 naturalKeyColor: Color = .white,
                                 accidentalKeyColor: Color = .black,
                                 visibleOctaves: Int = 1,
                                 settingsEnabled: Bool = true) -> AnyView {
